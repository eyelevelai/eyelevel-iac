...
resource "helm_release" "prometheus_redis_exporter" {
  count = local.create_monitor && local.create_cache ? 1 : 0
              ...
              rules = [
                {
                  ...
                  annotations = {
                    ...
                    description = "The metric '${var.layout_internal.service}_capacity_requests' has been zero or undefined for the past 5 minutes. Trigger scaling."
                  }
                }
              ]
            },
              ...
              rules = [
                {
                  ...
                  annotations = {
                    ...
                    description = "The metric '${var.ranker_internal.service}_capacity_requests' has been zero or undefined for the past 5 minutes. Trigger scaling."
                  }
                }
              ]
            },
              ...
              rules = [
                {
                  ...
                  annotations = {
                    ...
                    description = "The metric '${var.summary_internal.service}_capacity_requests' has been zero or undefined for the past 5 minutes. Trigger scaling."
                  }
                }
              ]
            },
